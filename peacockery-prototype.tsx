...
const Logo = () => (
  <div className="flex items-center gap-2">
    ...
    <span className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-teal-400 to-indigo-500">Peacockery</span>
  </div>
);
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            ...
            <a href="#stack" className="text-gray-300 hover:text-teal-400">Tech Stack</a>
            <a href="#team" className="text-gray-300 hover:text-teal-400">Team</a>
      ...
      <div className="container mx-auto px-6 z-10 text-center">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto">
            Where technology meets artistic expression. We build beautiful, functional digital experiences.
          </p>
        </motion.div>
        ...
        >
          <div>
            ...
            <motion.p 
              ...
              viewport={{ once: true }}
            >
              Peacockery draws inspiration from the boldness and authenticity of peacock displays in nature. We believe in creating digital experiences that are not just functional, but expressive, beautiful, and genuine.
            </motion.p>
            <motion.p 
              className="text-gray-300 mb-6"
              initial={{ y: 40 }}
              ...
              viewport={{ once: true }}
            >
              Founded with a passion for both technological innovation and artistic expression, our studio specializes in developing applications that stand out through their thoughtful design, seamless functionality, and authentic character.
            </motion.p>
            <motion.div
              className="mt-8"
      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="text-gray-300 max-w-2xl mx-auto">
            A showcase of our recent work across mobile and web platforms. Each project represents our commitment to both functionality and aesthetic excellence.
          </p>
        </motion.div>
    ...
    <section id="stack" className="py-20 bg-gradient-to-b from-navy-900 to-navy-950">
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="text-gray-300 max-w-2xl mx-auto">
            We carefully select the best tools for each project, balancing cutting-edge technology with proven reliability.
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="text-gray-300 mb-6">
            Every technology we adopt is selected based on performance, developer experience, and how it contributes to creating exceptional user experiences. We're constantly evaluating new tools while maintaining expertise in our core stack.
          </p>
    ...
    <section id="team" className="py-20 bg-navy-900">
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="text-gray-300 max-w-2xl mx-auto">
            A collective of passionate technologists, designers, and creative thinkers. We're always looking for exceptional talent to join us.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          >
            ...
            <p className="text-gray-300 mb-8">
              Feel free to reach out if you're looking for a development partner, have questions about our work, or are interested in joining our team.
            </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            ...
            <p className="mt-4 mb-6 max-w-md">
              At Peacockery, we blend technical excellence with artistic expression to create digital experiences that stand out in today's saturated digital landscape.
            </p>
